...
//   // Handle scroll effects - Fixed: Added proper dependencies and cleanup
//   useEffect(() => {
...
//       // Throttle the scroll down detection
...
//       if (scrollTimeout) clearTimeout(scrollTimeout);
//     };
//   }, [lastScrollY]); // Added lastScrollY as dependency

//   // Close mobile menu on route change - Fixed: Used proper state setter
//   useEffect(() => {
//     if (isOpen) {
//       setIsOpen(false);
//     }
//     setActiveDropdown(null);
//   }, [location.pathname]); // Added proper dependency
